...
import { useFilterCountHelpers } from '@/hooks/use-filter-count-helpers'
...
export function ProductFilters({
  ...
  // Use extracted hook for count lookups and disabled checks
  const {
    getGenderCount,
    ...
    isLongevityDisabled,
    isSillageDisabled,
  } = useFilterCountHelpers(filterCounts, filters)
