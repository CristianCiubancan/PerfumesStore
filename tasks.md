...
| 15 | Fire-and-forget email without retry mechanism | Reliability | `server/src/services/stripe-webhook.service.ts:79` | 4h | |
...
| 21 | No container image vulnerability scanning | DevOps | `.github/workflows/ci.yml` | 3h | |
...
- [ ] #27 - Set up CHANGELOG and versioning - 2h
...
- [ ] #21 - Add image vulnerability scanning - 3h
- [ ] #6 - Add APM/tracing (OpenTelemetry) - 8h
- [ ] #7 - Add Prometheus metrics - 6h

**Total: ~23 hours (6h completed, 17h remaining)**

### Backlog (Future Sprints)
- [ ] #15 - Email retry mechanism - 4h
...
- [ ] #39 - Increase shutdown timeout - 1h
